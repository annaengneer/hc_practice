import sys
result_dict = {4:'コンドル',-3:'アルバトロス',-2:'イーグル',-1:'バーティ',0:'パー'}
...
line1 = input_line[0].strip()
line2 = input_line[1].strip()

# 一行目と二行目をint型のリストに変換する(x =[4,4,5,3,5,4,4,3,4,4,5,4,4,3,4,4,3,5],y = [2,3,1,5,8,3,5,1,5,6,2,5,7,2,5,5,2,6])
x = [int(n) for n in line1.split(',')]
y = [int(n) for n in line2.split(',')]
...
for d, f in zip(r,y):
    if f == 1:
        ...
        result_list.append(result_dict.get(d, 'ボギー'))
print(result_list)
